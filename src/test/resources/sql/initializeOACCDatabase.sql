...
CREATE SEQUENCE OACC.OAC_ResourceClassID INCREMENT BY 1 MINVALUE 1 START WITH 1 NO CYCLE;

CREATE SEQUENCE OACC.OAC_PermissionID INCREMENT BY 1 MINVALUE 1 START WITH 1 NO CYCLE;

CREATE SEQUENCE OACC.OAC_DomainID INCREMENT BY 1 MINVALUE 1 START WITH 1 NO CYCLE;

CREATE SEQUENCE OACC.OAC_ResourceID INCREMENT BY 1 MINVALUE 1 START WITH 1 NO CYCLE;
